Ext.define('ExtMap.view.authentication.LockScreen', {
    extend: 'ExtMap.view.authentication.LockingWindow',
    xtype: 'lockscreen',

    requires: [
        'ExtMap.view.authentication.Dialog',
        'Ext.button.Button',
            ...
            items: [
                {
                    ...
                    items: [
                        ...
                        {
                            xtype: 'box',
                            html: '<div class=\'user-name-text\'>管理员</div><div class=\'user-post-text\'> Project manager </div>'
                        }
                    ]
                },
